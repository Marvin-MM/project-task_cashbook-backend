...
export class PaymentModesController {
    async getAll(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
        try {
            const modes = await paymentModesService.getPaymentModes(req.params.workspaceId as string);
    ...
    async create(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
        try {
            const mode = await paymentModesService.createPaymentMode(req.params.workspaceId as string, req.user.userId, req.body);
    ...
    async update(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
        try {
            const mode = await paymentModesService.updatePaymentMode(req.params.paymentModeId as string, req.user.userId, req.body);
    ...
    async delete(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
        try {
            await paymentModesService.deletePaymentMode(req.params.paymentModeId as string, req.user.userId);
