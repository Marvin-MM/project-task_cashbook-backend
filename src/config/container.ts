...
import { S3CleanupJob } from '../jobs/s3Cleanup';
...
container.registerSingleton(S3CleanupJob);
...
import { FilesController } from '../modules/files/files.service';
...
import { ReportsController } from '../modules/reports/reports.service';
